...
function Header() {
    ...
    <div className="timing d-flex pt-3"><div className='col-md-2 pt-6'><img src={timer}/></div><div className='pt-3'><strong>Opening Time</strong><p><small>Mon-Sat:7:00-17:00</small></p></div></div>
