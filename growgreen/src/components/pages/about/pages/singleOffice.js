    ...
    return (
        <div>
            ...
            <div className='pages mb-6 pb-16'>
                <p className='link-purpose mt-16 pt-6'><small><i><Link to='/'>Home </Link>/<Link to='/about'>About Us </Link>/<Link to='/office' style={{textDecoration:'none', color:'red'}}>Office</Link></i></small></p>
