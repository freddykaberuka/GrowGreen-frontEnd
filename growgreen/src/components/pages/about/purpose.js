        ...
        <div>
            ...
            <div className="card-deck mt-5 col-sm-12 row-cols-1">
                <div className="card">
                    ...
                    <div className='font-weight-normal pt-4 title'>Purpose and Value</div>
                </div>
                <div class="card">
                    <img className="card-img-top fit-image" src={image2} alt="Card image cap"/>
                    <div className='font-weight-normal pt-4 title'>Our Mission</div>
                </div>
                <div class="card">
                    <img className="card-img-top fit-image" src={image2} alt="Card image cap"/>
                    <div className='font-weight-normal pt-4 title'>Leadership</div>
                </div>
